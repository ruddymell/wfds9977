...
CHARACTER(60) :: CHID,RESTART_CHID
...
CHARACTER(80), ALLOCATABLE, DIMENSION(:)   :: FN_GEOM,FN_BNDE
CHARACTER(80), ALLOCATABLE, DIMENSION(:,:) :: FN_SLCF,FN_BNDF,FN_ISOF,FN_SMOKE3D,FN_BNDF_SLCF
CHARACTER(120), ALLOCATABLE, DIMENSION(:)   :: FN_VEG_OUT
...
INTEGER :: N_TREES,N_TREES_OUTPUT_DATA,N_TREES_IN_FILE
...
LOGICAL :: CONE_TREE_PRESENT,FRUSTUM_TREE_PRESENT,CYLINDER_TREE_PRESENT,RING_TREE_PRESENT, &
           RECTANGLE_TREE_PRESENT,IGNITOR_PRESENT,CREATE_VEG_FILE
...
CHARACTER(30),ALLOCATABLE, DIMENSION(:) :: VEG_FUEL_GEOM, VEG_LABELS,VEG_TREE_NAME
CHARACTER(60) :: VEG_INPUT_FILENAME
...
INTEGER, ALLOCATABLE, DIMENSION(:) :: N_TREE_OUT,TREE_CFCR_INDEX,TREE_FRUSTUM_INDEX,TREE_RING_INDEX,TREE_RECT_INDEX, &
                                      TREE_IGN_INDEX,N_TREE_IN_FILE,N_TREE_FOR_PRT_FILE

...
IMPLICIT NONE
CHARACTER(255), PARAMETER :: dataid='$Id: data.f90 9974 2012-02-03 18:41:26Z mcgratta $'
CHARACTER(255), PARAMETER :: datarev='$Revision: 9974 $'
CHARACTER(255), PARAMETER :: datadate='$Date: 2012-02-03 10:41:26 -0800 (Fri, 03 Feb 2012) $'

INTEGER, PARAMETER :: N_OUTPUT_QUANTITIES=450
...
REAL(EB),ALLOCATABLE, DIMENSION(:) :: HRR,Q_RADI,Q_WALL,Q_OPEN,FUEL_PARTICLE_MLR,MLR, &
                                      HRR_SUM,Q_RADI_SUM,Q_WALL_SUM,Q_OPEN_SUM,MLR_SUM,HRR_TIME_INTERVAL
REAL(EB),ALLOCATABLE, DIMENSION(:,:) :: MINT,MINT_SUM
REAL(EB),ALLOCATABLE, DIMENSION(:) :: MINT_TIME_INTERVAL

TYPE OUTPUT_QUANTITY_TYPE
   CHARACTER(30) :: NAME='null',OLD_NAME='null',SHORT_NAME='null',UNITS='null'
...
OUTPUT_QUANTITY(103)%NAME  = 'BULK RICHARDSON NUMBER'
OUTPUT_QUANTITY(103)%UNITS  = ' '
OUTPUT_QUANTITY(103)%SHORT_NAME  = 'Ri'
...
!The following three lines were present before the vegeation quantities were accounted for below
...
!Vegetation
OUTPUT_QUANTITY(441)%NAME = 'VEG_DRY_MASS'                     
OUTPUT_QUANTITY(441)%UNITS = 'kg'                       
OUTPUT_QUANTITY(441)%SHORT_NAME = 'vegdry'

OUTPUT_QUANTITY(442)%NAME = 'VEG_MOIST_MASS'                     
OUTPUT_QUANTITY(442)%UNITS = 'kg'                       
OUTPUT_QUANTITY(442)%SHORT_NAME = 'vegmoist'

OUTPUT_QUANTITY(443)%NAME = 'VEG_DIVQC'                     
OUTPUT_QUANTITY(443)%UNITS = 'kW/m2'                       
OUTPUT_QUANTITY(443)%SHORT_NAME = 'vegqc'

OUTPUT_QUANTITY(444)%NAME = 'VEG_DIVQR'                     
OUTPUT_QUANTITY(444)%UNITS = 'kW/m2'                       
OUTPUT_QUANTITY(444)%SHORT_NAME = 'vegqr'

OUTPUT_QUANTITY(445)%NAME = 'VEG_CHAR_MASS'                     
OUTPUT_QUANTITY(445)%UNITS = 'kg'                       
OUTPUT_QUANTITY(445)%SHORT_NAME = 'vegchar'

OUTPUT_QUANTITY(446)%NAME = 'VEG_ASH_MASS'                     
OUTPUT_QUANTITY(446)%UNITS = 'kg'                       
OUTPUT_QUANTITY(446)%SHORT_NAME = 'vegash'

OUTPUT_QUANTITY(447)%NAME = 'VEG_Q_CHAROX'                     
OUTPUT_QUANTITY(447)%UNITS = 'kW'                       
OUTPUT_QUANTITY(447)%SHORT_NAME = 'vegQcharox'

OUTPUT_QUANTITY(434:447)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(434:447)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(434:447)%DEVC_APPROPRIATE = .FALSE.

! Boundary Quantities (Negative indices)
 
OUTPUT_QUANTITY(-1)%NAME = 'RADIATIVE HEAT FLUX'          
OUTPUT_QUANTITY(-1)%OLD_NAME = 'RADIATIVE_FLUX'          
...
OUTPUT_QUANTITY(-20)%OLD_NAME = 'MASS_FLUX'
...
OUTPUT_QUANTITY(-28)%NAME= 'SURFACE DEPOSITION'
OUTPUT_QUANTITY(-28)%UNITS= 'kg/m2'
OUTPUT_QUANTITY(-28)%SHORT_NAME= 'soot dep'
OUTPUT_QUANTITY(-28)%SPEC_ID_REQUIRED=.TRUE.
...
USE GLOBAL_CONSTANTS, ONLY: GAMMA,Y_O2_INFTY,CONSTANT_SPECIFIC_HEAT
